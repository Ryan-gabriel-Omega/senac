CREATE DATABASE ExercicioPraia2;
USE ExercicioPraia2;
...
INSERT INTO cliente 
(nomeCliente, cpf, email, cidade, estado)
VALUES
...
('Pateta','02102054210','pateta@gmail','Santos','SP'),
...
SET @ultimoAluguel = LAST_INSERT_ID();
...
VALUES
(2, @ultimoAluguel, 7.00, 3.50, 2),
(4, @ultimoAluguel, 3.00, 3.00, 1);
...
VALUES
(1, @ultimoAluguel, 6.00, 2.00, 3),
(5, @ultimoAluguel, 1.50, 1.50, 1);
...
COUNT(aluguel.idAluguel) AS AlugueisTotais
FROM cliente
JOIN aluguel
